...
//        });
//        
//var stageSpine = new Kinetic.Stage(
//        {
//           container: "tailcontent",
//            width: 256,
//            height: 256
...
//
//var imgSpinePaths = [];
//imgSpinePaths[0] = "img/classic/spinebase.png";
//
//
...
//
//var initialSpineColorValues = [];
//initialSpineColorValues[0] = "aa0707";
//
//var tail = [];
//var fin = [];
//var spine = [];
...
//}
//
//for(var j = 0; j < imgSpinePaths.length; j++)
//{
//    spine[j] = new Texture(imgSpinePaths[j], stageSpine);
//    spine[j].img = new Image();
//    spine[j].img.onload = imgLoaded(spine[j]);
//    spine[j].img.src = spine[j].imgSource;
//    
//    spine[j].addColorControls(false, initialSpineColorValues[j], "control-spine-container");
//        setSpineControls(j, false);
//}
//
...
//}
//
//function setSpineControls(e, sel)
//{
//    var picker = spine[e].color;
//    picker.setAttribute("onchange", "changeTextureFromCanvas()");
//    
//    if(sel === true)
//    {
//        var select = spine[e].select;
//        select.setAttribute("onchange", "spine[" + e + "].toggle()");
//    }
//}
//
...
//            }, false);
//            
//    stageSpine.toDataURL(
//            {
//                callback: function (dataUrl)
//                {
//                    //console.log(dataUrl);
//                    changeSpineTexture(dataUrl);
//                }
//
//            }, false);        
//}
